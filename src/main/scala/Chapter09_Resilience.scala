...
object App4 extends helpers.ZIOAppDebug:
  ...
  // Current requests: List(375, 380)
  // Current requests: List(104, 375, 380)
  // Current requests: List(101, 104, 375, 380)
...
object App5 extends helpers.ZIOAppDebug:
  ...
  // Delicate Resource constructed.
  // Do not make more than 3 concurrent requests!
  // Current requests: List(564)
  // Current requests: List(12, 564)
  // Current requests: List(520, 12, 564)
  // Current requests: List(237, 520, 12)
  // Current requests: List(15, 237, 520)
  // Current requests: List(742, 15, 237)
  // Current requests: List(924, 742, 15)
  // Current requests: List(512, 924)
  // Current requests: List(490, 512, 924)
  // Current requests: List(2, 490, 512)
