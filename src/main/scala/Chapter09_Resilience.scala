...
object App5 extends helpers.ZIOAppDebug:
  ...
  // Current requests: List(65, 352)
  // Current requests: List(593, 65, 352)
  // Current requests: List(955, 593, 65, 352)
...
object App6 extends helpers.ZIOAppDebug:
  ...
  // Delicate Resource constructed.
  // Do not make more than 3 concurrent requests!
  // Current requests: List(953)
  // Current requests: List(293, 953)
  // Current requests: List(767, 293, 953)
  // Current requests: List(25, 767, 953)
  // Current requests: List(706, 25)
  // Current requests: List(919, 706, 25)
  // Current requests: List(16, 919)
  // Current requests: List(609, 16, 919)
  // Current requests: List(963, 609, 16)
  // Current requests: List(414, 963)
