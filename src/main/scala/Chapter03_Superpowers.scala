...
val effect5 =
  effect4.withFinalizer:
    // TODO This is wrong. It's not a
    // username. It's simply whatever string
    // was returned from effect4, which can
    // also be a failure message.
    // Should show the sad path to
    // demonstrate that
...
object App8 extends helpers.ZIOAppDebug:
  ...
  // Attempting to save user
  // Log: Signup initiated for Morty
  // Result: (PT5.001931346S,User saved)
