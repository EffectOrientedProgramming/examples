...
object Chapter10_Appendix_RunningEffects_0 extends ZIOSpecDefault:
  ...
  // + random is random
  // Result: Summary(1,0,0,,PT0.56576S)
...
object Chapter10_Appendix_RunningEffects_1 extends ZIOSpecDefault:
  ...
  // Result: Summary(1,0,0,,PT0.084646S)
...
""".stripMargin
  ...
  // - console works
  //   Exception in thread "zio-fiber-715211833" scala.NotImplementedError: an implementation is missing
