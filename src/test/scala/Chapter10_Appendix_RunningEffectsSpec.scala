...
object Chapter10_Appendix_RunningEffects_0 extends ZIOSpecDefault:
  ...
  // Log: Signup initiated for Morty
  // + random is random
  // Result: Summary(1,0,0,,PT0.472869731S)
...
object Chapter10_Appendix_RunningEffects_1 extends ZIOSpecDefault:
  ...
  // Result: Summary(1,0,0,,PT0.230885957S)
...
""".stripMargin
  ...
  // - console works
  //   Exception in thread "zio-fiber-1207619985" scala.NotImplementedError: an implementation is missing
