...
object Test0 extends ZIOSpecDefault:
  ...
  // Num Heads = 10
  // + flips 10 times
  // Result: Summary(1,0,0,,PT0.336584S)
...
object Test1 extends ZIOSpecDefault:
  ...
  // R: Heads
  // + rosencrantzAndGuildensternAreDead finishes
  // Result: Summary(1,0,0,,PT0.047685S)
...
object Test2 extends ZIOSpecDefault:
  ...
  // R: Heads
  // Tails
  // <FAIL> R: Fail(Tails,Stack trace for thread "zio-fiber-828955209":
  ...
  // R: Heads
  // + flaky plan
  // Result: Summary(1,0,0,,PT0.023721S)
...
object Test3 extends ZIOSpecDefault:
  ...
  // Result: Summary(1,0,0,,PT0.040787S)
