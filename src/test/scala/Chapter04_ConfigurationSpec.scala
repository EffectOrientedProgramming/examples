...
object Chapter04_Configuration_0 extends ZIOSpecDefault:
  ...
  // Num Heads = 10
  // + flips 10 times
  // Result: Summary(1,0,0,,PT0.065036S)
...
object Chapter04_Configuration_1 extends ZIOSpecDefault:
  ...
  // R: Heads
  // + rosencrantzAndGuildensternAreDead finishes
  // Result: Summary(1,0,0,,PT0.033769S)
...
object Chapter04_Configuration_2 extends ZIOSpecDefault:
  ...
  // *Performance Begins*
  // Tails
  // <FAIL> R: Fail(Tails,Stack trace for thread "zio-fiber-820996":
  ...
  // R: Heads
  // + flaky plan
  // Result: Summary(1,0,0,,PT0.048924S)
...
object Chapter04_Configuration_3 extends ZIOSpecDefault:
  ...
  // Result: Summary(1,0,0,,PT0.026797S)
